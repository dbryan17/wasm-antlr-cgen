// Generated from /Users/dakotabryan/SYE/wasm-antlr/Fractal.g4 by ANTLR 4.9.2
...
public class FractalParser extends Parser {
	...
	public static final int
		...
		T__45=46, POS_INT=47, NUMBER=48, CPX_NUMBER_IM=49, PIXEL=50, ITERATE=51, 
		EXP=52, COS=53, SIN=54, TAN=55, COSH=56, SINH=57, TANH=58, RE=59, IM=60, 
		BAR=61, ARG=62, LOG=63, SQRT=64, ARCCOS=65, ARCSIN=66, ARCTAN=67, POW=68, 
		PLUS=69, MINUS=70, TIMES=71, DIVIDE=72, EQUALS=73, GT=74, LT=75, VARIABLE=76, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'par'", "'dyn'", "'reduce'", "'mod'", "'escapes'", "'vanishes'", "'stops'", 
			"'or'", "'and'", "'xor'", "'if'", "'then'", "'else'", "'do'", "'until'", 
			"'on'", "'repeat'", "'times'", "'checkered'", "'disc'", "'period 3 cycle'", 
			"'red'", "'green'", "'blue'", "'omega'", "'omegabar'", "'Purple'", "'White'", 
			"'Orange'", "'['", "'|'", "']'", "'is'", "'real'", "'integer'", "'probe'", 
			"'\"'", "'report'", "'\u2206'", null, null, null, "'pixel'", "'iterate'", 
			"'exp'", "'cos'", "'sin'", "'tan'", "'cosh'", "'sinh'", "'tanh'", "'re'", 
			"'im'", "'bar'", "'arg'", "'log'", "'sqrt'", "'arccos'", "'arcsin'", 
			"'arctan'", "'^'", "'+'", "'-'", "'*'", "'/'", "'='", "'>'", "'<'", null, 
			"'('", "')'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, "POS_INT", 
			"NUMBER", "CPX_NUMBER_IM", "PIXEL", "ITERATE", "EXP", "COS", "SIN", "TAN", 
			"COSH", "SINH", "TANH", "RE", "IM", "BAR", "ARG", "LOG", "SQRT", "ARCCOS", 
			"ARCSIN", "ARCTAN", "POW", "PLUS", "MINUS", "TIMES", "DIVIDE", "EQUALS", 
			"GT", "LT", "VARIABLE", "LPAREN", "RPAREN", "WS", "COMMENT"
		};
	}
	...
	public final ScriptContext script() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__3) | (1L << T__4) | (1L << T__5) | (1L << T__7) | (1L << T__8) | (1L << T__17) | (1L << T__20) | (1L << T__23) | (1L << T__36) | (1L << ITERATE))) != 0) );
			}
		}
	...
	public final Cpx_functionContext cpx_function() throws RecognitionException {
		...
		try {
			...
			setState(91);
			_la = _input.LA(1);
			if ( !(((((_la - 52)) & ~0x3f) == 0 && ((1L << (_la - 52)) & ((1L << (EXP - 52)) | (1L << (COS - 52)) | (1L << (SIN - 52)) | (1L << (TAN - 52)) | (1L << (COSH - 52)) | (1L << (SINH - 52)) | (1L << (TANH - 52)) | (1L << (RE - 52)) | (1L << (IM - 52)) | (1L << (BAR - 52)) | (1L << (ARG - 52)) | (1L << (LOG - 52)) | (1L << (SQRT - 52)))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Real_functionContext real_function() throws RecognitionException {
		...
		try {
			...
			setState(93);
			_la = _input.LA(1);
			if ( !(((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L <<