...
FractalParser::ScriptContext* FractalParser::script() {
  ...
  try {
    ...
    do {
      ...
      | (1ULL << FractalParser::T__17)
      | (1ULL << FractalParser::T__20)
      | (1ULL << FractalParser::T__23)
      | (1ULL << FractalParser::T__36)
...
FractalParser::CommandContext* FractalParser::command() {
  ...
  try {
    ...
    switch (_input->LA(1)) {
      ...
      case FractalParser::T__20:
      case FractalParser::T__23:
...
FractalParser::Cpx_functionContext* FractalParser::cpx_function() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (!(((((_la - 52) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 52)) & ((1ULL << (FractalParser::EXP - 52))
      | (1ULL << (FractalParser::COS - 52))
      | (1ULL << (FractalParser::SIN - 52))
      | (1ULL << (FractalParser::TAN - 52))
      | (1ULL << (FractalParser::COSH - 52))
      | (1ULL << (FractalParser::SINH - 52))
      | (1ULL << (FractalParser::TANH - 52))
      | (1ULL << (FractalParser::RE - 52))
      | (1ULL << (FractalParser::IM - 52))
      | (1ULL << (FractalParser::BAR - 52))
      | (1ULL << (FractalParser::ARG - 52))
      | (1ULL << (FractalParser::LOG - 52))
      | (1ULL << (FractalParser::SQRT - 52)))) != 0))) {
    _errHandler->recoverInline(this);
    }
    else {
      _errHandler->reportMatch(this);
...
FractalParser::Real_functionContext* FractalParser::real_function() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (!(((((_la - 65) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 65)) & ((1ULL << (FractalParser::ARCCOS - 65))
      | (1ULL << (FractalParser::ARCSIN - 65))
      | (1ULL << (FractalParser::ARCTAN - 65)))) != 0))) {
    _errHandler->recoverInline(this);
    }
    else {
      _errHandler->reportMatch(this);
  ...
  try {
    ...
    while (alt != 2 && alt != atn::ATN::INVALID_ALT_NUMBER) {
      if (alt == 1) {
        ...
        _la = _input->LA(1);
        if (!((((_la & ~ 0x3fULL) == 0) &&
          ((1ULL << _la) & ((1ULL << FractalParser::T__14)
          | (1ULL << FractalParser::T__15)
          | (1ULL << FractalParser::T__16))) != 0))) {
        _errHandler->recoverInline(this);
        }
        else {
          _errHandler->reportMatch(this);
...
FractalParser::LoopContext* FractalParser::loop() {
  ...
  try {
    ...
    case 4: {
      ...
      enterOuterAlt(_localctx, 4);
      setState(208);
      match(FractalParser::T__23);
      setState(209);
      n();
      setState(210);
      match(FractalParser::T__24);
      setState(211);
      command();
      break;
    }
...
FractalParser::FlagnameContext* FractalParser::flagname() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (!((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & ((1ULL << FractalParser::T__25)
      | (1ULL << FractalParser::T__26)
      | (1ULL << FractalParser::T__27))) != 0))) {
    _errHandler->recoverInline(this);
    }
    else {
      _errHandler->reportMatch(this);
...
FractalParser::ColorContext* FractalParser::color() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (!((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & ((1ULL << FractalParser::T__28)
      | (1ULL << FractalParser::T__29)
      | (1ULL << FractalParser::T__30)
      | (1ULL << FractalParser::T__31)
      | (1ULL << FractalParser::T__32)
      | (1ULL << FractalParser::T__33)
      | (1ULL << FractalParser::T__34)
      | (1ULL << FractalParser::T__35))) != 0))) {
    _errHandler->recoverInline(this);
    }
    else {
      _errHandler->reportMatch(this);
...
FractalParser::Color_commandContext* FractalParser::color_command() {
  ...
  try {
    ...
    case 1: {
      enterOuterAlt(_localctx, 1);
      setState(219);
      match(FractalParser::T__36);
      setState(220);
      flagname();
      setState(221);
      match(FractalParser::T__37);
      setState(222);
      color();
      setState(223);
...
FractalParser::Num_typeContext* FractalParser::num_type() {
  ...
  try {
    ...
    setState(247);
    _la = _input->LA(1);
    if (!(_la == FractalParser::T__40

    || _la == FractalParser::T__41)) {
    _errHandler->recoverInline(this);
    }
    else {
      _errHandler->reportMatch(this);
...
FractalParser::Probe_commandContext* FractalParser::probe_command() {
  ...
  try {
    ...
    enterOuterAlt(_localctx, 1);
    setState(249);
    match(FractalParser::T__42);
    setState(250);
    num_type();

    setState(251);
    match(FractalParser::T__43);
    setState(253); 
    _errHandler->sync(this);
    alt = 1 + 1;
    do {
...
std::vector<std::string> FractalParser::_literalNames = {
  ...
  "'dyn'", "'reduce'", "'mod'", "'escapes'", "'vanishes'", "'stops'", "'or'", 
  "'and'", "'xor'", "'if'", "'then'", "'else'", "'do'", "'until'", "'on'", 
  "'repeat'", "'times'", "'checkered'", "'disc'", "'period 3 cycle'", "'red'", 
  "'green'", "'blue'", "'omega'", "'omegabar'", "'Purple'", "'White'", "'Orange'", 
  "'['", "'|'", "']'", "'is'", "'real'", "'integer'", "'probe'", "'\"'", 
  "'report'", "'\u2206'", "", "", "", "'pixel'", "'iterate'", "'exp'", "'cos'", 
...
std::vector<std::string> FractalParser::_symbolicNames = {
  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
  "", "", "", "", "", "", "", "", "", "", "", "POS_INT", "NUMBER", "CPX_NUMBER_IM", 
  "PIXEL", "ITERATE", "EXP", "COS", "SIN", "TAN", "COSH", "SINH", "TANH", 
  "RE", "IM", "BAR", "ARG", "LOG", "SQRT", "ARCCOS", "ARCSIN", "ARCTAN", 
  "POW", "PLUS", "MINUS", "TIMES", "DIVIDE", "EQUALS", "GT", "LT", "VARIABLE", 
  "LPAREN", "RPAREN", "WS", "COMMENT"
};
...
FractalParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x28, 0x2, 0xa, 0x3, 0x2, 0x7, 0x8, 0x3, 0x2, 0x36, 0x42, 0x3, 0x2, 
    0x43, 0x45, 0x3, 0x2, 0x47, 0x48, 0x3, 0x2, 0x11, 0x13, 0x3, 0x2, 0x1c, 
    0x1e, 0x3, 0x2, 0x1f, 0x26, 0x3, 0x2, 0x2b, 0x2c, 0x2, 0x128, 0x2, 0x2d, 
    ...
    0x31, 0x2, 0x2, 0x4d, 0x7, 0x3, 0x2, 0x2, 0x2, 0x4e, 0x52, 0x5, 0xc, 
    ...
    0x7, 0x32, 0x2, 0x2, 0x56, 0xd, 0x3, 0x2, 0x2, 0x2, 0x57, 0x58, 0x7, 
    0x33, 0x2, 0x2, 0x58, 0xf, 0x3, 0x2, 0x2, 0x2, 0x59, 0x5c, 0x5, 0x8, 
    ...
    0x2, 0x2, 0x7b, 0x7c, 0xc, 0xa, 0x2, 0x2, 0x7c, 0x7d, 0x7, 0x49, 0x2, 
    0x2, 0x7d, 0x8b, 0x5, 0x16, 0xc, 0xb, 0x7e, 0x7f, 0xc, 0x9, 0x2, 0x2, 
    0x7f, 0x80, 0x7, 0x4a, 0x2, 0x2, 0x80, 0x8b, 0x5, 0x16, 0xc, 0xa, 0x81, 
    0x82, 0xc, 0x8, 0x2, 0x2, 0x82, 0x83, 0x7, 0x47, 0x2, 0x2, 0x83, 0x8b, 
    0x5, 0x16, 0xc, 0x9, 0x84, 0x85, 0xc, 0x7, 0x2, 0x2, 0x85, 0x86, 0x7, 
    0x48, 0x2, 0x2, 0x86, 0x8b, 0x5, 0x16, 0xc, 0x8, 0x87, 0x88, 0xc, 0xb, 
    0x2, 0x2, 0x88, 0x89, 0x7, 0x46, 0x2, 0x2, 0x89, 0x8b, 0x5, 0x6, 0x4, 
    ...
    0x1, 0x2, 0x90, 0x98, 0x5, 0x16, 0xc, 0x2, 0x91, 0x99, 0x7, 0x4c, 0x2, 
